...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../ponude.test-samples';

import { PonudeService } from './ponude.service';

const requireRestSample: IPonude = {
...
describe('Ponude Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Ponude', () => {
      ...
      const ponude = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(ponude).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Ponude', () => {
      const ponude = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(ponude).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addPonudeToCollectionIfMissing', () => {
      it('should add a Ponude to an empty array', () => {
        const ponude: IPonude = sampleWithRequiredData;
      ...
      it("should add a Ponude to an array that doesn't contain it", () => {
        const ponude: IPonude = sampleWithRequiredData;
        const ponudeCollection: IPonude[] = [sampleWithPartialData];
        expectedResult = service.addPonudeToCollectionIfMissing(ponudeCollection, ponude);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(ponude);
      });
      ...
      it('should add only unique Ponude to an array', () => {
        const ponudeArray: IPonude[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const ponudeCollection: IPonude[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const ponude: IPonude = sampleWithRequiredData;
        const ponude2: IPonude = sampleWithPartialData;
    ...
    describe('comparePonude', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.comparePonude(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.comparePonude(entity1, entity2);
        const compareResult2 = service.comparePonude(entity2, entity1);
